...
const styles = {
  ...
  INFO: "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/45 dark:text-cyan-100",
  ALERT: "bg-amber-100 text-amber-800 dark:bg-amber-900/45 dark:text-amber-100",
  SYSTEM: "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/45 dark:text-indigo-100",
